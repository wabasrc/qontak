...
class Request
{
    ...
    {
        $ci =& get_instance();
        $this->baseUrl = $ci->config->item('services.qontak.base_url');
        $this->username = $ci->config->item('services.qontak.username');
        $this->password = $ci->config->item('services.qontak.password');
        $this->clientId = $ci->config->item('services.qontak.client_id');
        $this->clientSecret = $ci->config->item('services.qontak.client_secret');
        $this->channelId = $ci->config->item('services.qontak.channel_id');
    }
